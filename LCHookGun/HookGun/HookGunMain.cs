...
namespace HookGun
{
    ...
    [BepInPlugin(PluginInfos.MODUID, PluginInfos.MODNAME, PluginInfos.MODVERSION)]
        ...
        public class HookGunScript : GrabbableObject
        {
            ...
            public override void Update()
            {
                ...
                if (this.isHeld)
                {
                    ...
                    {
                        this.gameObject.transform.Find("HookOBJ").gameObject.SetActive(true);
                    }
                    else
                    {
                        this.gameObject.transform.Find("HookOBJ").gameObject.SetActive(false);
                    }
